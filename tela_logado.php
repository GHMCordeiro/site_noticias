    ...
    <div class="container-fluid">
        <div class="row justify-content-between pt-4 pb-2 bg-menu menu align-items-center">
             <div class="col-md-2 col-sm-2 logo2" >
                <a href="#"><img src="img/logo.svg" alt="" class="logoImg"></a>
            </div>

            <div class="col-md-5 col-sm-5">
                <div class="row justify-content-center text-center pt-2 pb-3">
                    <div class="col-md-2 col-sm-2 itens titulo text-center"><a href="#">Novidades</a></div>
            ...
            <div class="col-md-2 col-sm-4 botao2">
                <div class="row justify-content-around logado text-center">
                    <div class="col-md-6 col-sm-5 tam">
                        <a href="cadastros.php" class="btn btn-cor btn-cad"><span class="font-cad">Cadastros</span></a>
                    </div>

                    <div class="col-md-6 col-sm-3 tam">
                        <a href="index.php" class="btn btn-cor2 btn-logout"><span class="font-cad">Sair</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 pb-4">
                <h3 class="card-title mt-5"> Novidades </h3>
                <hr class="nov">
            </div>
        </div>
        ...
        ?>
            <div class="row mt-5 mb-5">
                ...
                <div class="col-md-6 col-sm-5 p-3">
                    <div class="row">
